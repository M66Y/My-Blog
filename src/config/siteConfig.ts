...
export const siteConfig: SiteConfig = {
	...
	// 站点描述
	description:
		"寻星star——循心的个人博客。记录 Agent 开发学习之旅、项目实践与生活随笔。如同流星飞跃天际，寻找属于自己的那颗星。",
	...
	// 已清空：标签页不显示自定义图标（站内导航栏已有星星 logo）
	favicon: [],
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "assets/images/logo/xunxing-logo-light.png",
			valueDark: "assets/images/logo/xunxing-logo-dark.png",
			alt: "⭐",
		},
		// 导航栏标题
		title: "寻星star",

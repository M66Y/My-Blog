...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	common: {
		...
		homeText: {
			...
			enable: true,
			// 主页横幅主标题
			title: "Love! Life! Love Life!",
			// 主页横幅主标题字体大小
			titleSize: "4.5rem",
			// 主页横幅副标题
			subtitle: [
				"Like a shooting star streaking across the sky",
				"Until the earth turns into a lime",
				"Fireflies rushing into the flame, living by facing death",
				"Prosperous and bustling, dazed and confused, fireworks and sparks",
				"The spring morning is just perfect.",
				"In spring, a messenger who brings hope",
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
			typewriter: {
